...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className='absolute top-40 right-20 w-32 h-32 bg-purple-500/10 rounded-full animate-float blur-sm'
        style={{ animationDelay: '2s' }}
      />
      <div
        className='absolute bottom-40 left-20 w-16 h-16 bg-pink-500/10 rounded-full animate-float blur-sm'
        ...
        <div className='text-center max-w-4xl mx-auto'>
          ...
          >
            <h1 className='text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-4'>
              Hi, I'm{' '}
              <span className='gradient-text animate-glow'>Iwu Francis</span>
            </h1>
          ...
          >
            <Button
              ...
              onClick={() =>
                window.open(
                  'https://github.com/Iamtheusername112/Latest-Portfolio',
                  '_blank'
                )
              }
              title='GitHub'
            ...
            <Button
              ...
              onClick={() =>
                window.open(
                  'https://www.linkedin.com/in/francis-iwu?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
                  '_blank'
                )
              }
              title='LinkedIn'
            ...
            <Button
              ...
              className='h-12 w-12 rounded-full glass hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover:scale-110'
              onClick={() =>
                window.open('mailto:iwufrancischisom20@gmail.com', '_blank')
              }
              title='Email'
            >
