...
const DynamicFooter = () => {
              ...
              <div className='space-y-4'>
                ...
                <div className='flex space-x-4'>
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        'https://github.com/Iamtheusername112',
                        '_blank'
                      )
                    }
                    aria-label='GitHub'
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        'https://linkedin.com/in/francis-iwu-878973238',
                        '_blank'
                      )
                    }
                    aria-label='LinkedIn'
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        'https://www.instagram.com/fran_cis3831?igsh=azdxemFwNGl0dzU3',
                        '_blank'
                      )
                    }
  ...
  return (
    <footer
      className={`bg-${
        styling?.backgroundColor || 'background'
      } border-t border-${
    ...
    >
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10'>
        ...
        >
          <div
            className={`grid md:grid-cols-${layout?.columns || 3} gap-8 mb-8`}
          >
            {/* Brand Section */}
                ...
                {brand.tagline && (
                  <p
                    className={`text-sm text-${
                      styling?.textColor || 'muted-foreground'
                    } mt-2`}
                  >
                    {brand.tagline}
                  </p>
                      ...
                      {socialLinks.map((social, index) => {
                        ...
                        return (
                          <Button
                            ...
                            variant='ghost'
                            size='icon'
                            className={`h-10 w-10 rounded-full glass hover:bg-${
                              styling?.accentColor || 'primary'
                            } hover:text-primary-foreground transition-all duration-300 hover:scale-110`}
            ...
            {layout?.showContactInfo && contactInfo && (
              <div className='space-y-4'>
                ...
                <div
                  className={`space-y-2 text-sm text-${
                    styling?.textColor || 'muted-foreground'
                  }`}
                >
          ...
          {layout?.showCopyright && copyright && (
            <div className='pt-8 border-t border-border'>
              <div className='flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0'>
                ...
                >
                  © {copyright.showYear ? currentYear : ''}{' '}
                  {brand?.name || 'Iwu Francis'}.{' '}
