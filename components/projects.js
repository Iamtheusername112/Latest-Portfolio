...
const Projects = () => {
  const projects = [
    ...
    },
    {
      title: 'Blog CMS',
      description:
        'A headless CMS for bloggers with markdown support, SEO optimization, and content management capabilities.',
      image: '/api/placeholder/600/400',
    ...
    },
    {
      ...
      description:
        "An intelligent chat assistant powered by OpenAI's API with conversation history, context awareness, and multi-language support.",
      image: '/api/placeholder/600/400',
      technologies: [
        'React',
        'OpenAI API',
          ...
          <motion.div variants={itemVariants} className='mb-16'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8'>
              {featuredProjects.map((project, index) => (
                <Card
                  key={index}
                  className='group overflow-hidden glass border-border/50 card-premium'
                >
                  <div className='relative overflow-hidden'>
                    <div className='aspect-video bg-gradient-to-br from-primary/20 to-purple-500/20 flex items-center justify-center'>
                      <div className='text-6xl text-primary/50 animate-float'>
                        🚀
                      </div>
                    </div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6'>
              {otherProjects.map((project, index) => (
                <Card
                  key={index}
                  className='group glass border-border/50 card-premium'
                >
                  <div className='relative overflow-hidden'>
                    <div className='aspect-video bg-gradient-to-br from-primary/20 to-purple-500/20 flex items-center justify-center'>
                      <div className='text-4xl text-primary/50 animate-float'>
                        💻
                      </div>
                    </div>
