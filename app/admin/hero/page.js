        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              ...
              <Button variant="outline" size="lg" className="w-full sm:w-auto btn-premium glass">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Customize your hero section content and appearance</p>
          </div>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {heroData.profileImageUrl && (
                    <Input
                      ...
                      onChange={(e) => setHeroData(prev => ({ ...prev, profileImageUrl: e.target.value }))}
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setHeroData(prev => ({ ...prev, backgroundType: value }))}
                  >
                    <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    {heroData.backgroundImageUrl && (
                      <Input
                        ...
                        onChange={(e) => setHeroData(prev => ({ ...prev, backgroundImageUrl: e.target.value }))}
                        placeholder="Or enter image URL"
                        className="mt-2"
                      />
                    )}
                  ...
                  <div className="space-y-2">
                    ...
                    {heroData.backgroundVideoUrl && (
                      <Input
                        ...
                        onChange={(e) => setHeroData(prev => ({ ...prev, backgroundVideoUrl: e.target.value }))}
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => setHeroData(prev => ({ ...prev, primaryButtonAction: value }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  {(heroData.primaryButtonAction === 'link' || heroData.primaryButtonAction === 'download') && (
                    <Input
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => setHeroData(prev => ({ ...prev, secondaryButtonAction: value }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  {(heroData.secondaryButtonAction === 'link' || heroData.secondaryButtonAction === 'download') && (
                    <Input
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {heroData.showScrollIndicator && (
                  <div className="space-y-2">
                    <Label htmlFor="scrollIndicatorText">Scroll Indicator Text</Label>
                    <Input
                      id="scrollIndicatorText"
                      value={heroData.scrollIndicatorText}
                      onChange={(e) => setHeroData(prev => ({ ...prev, scrollIndicatorText: e.target.value }))}
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setHeroData(prev => ({ ...prev, customCss: e.target.value }))}
