...
export async function initializeDatabase() {
  try {
    ...
    console.log('🎨 Initializing logo settings...');
    await LogoService.createInitialLogoSettings();

    // Initialize SEO settings
    console.log('🔍 Initializing SEO settings...');
    await SEOService.createInitialSEOSettings();

    // Initialize appearance settings
    console.log('🎨 Initializing appearance settings...');
    await AppearanceService.createInitialAppearanceSettings();
    ...
    await FooterService.createDefaultFooterSettings();
