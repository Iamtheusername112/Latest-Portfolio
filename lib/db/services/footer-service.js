...
export class FooterService {
  ...
  static async updateFooterSettings(footerData) {
    try {
      ...
      const existingSettings = await db.select().from(footerSettings).limit(1)
  ...
  static validateFooterData(footerData) {
    ...
    if (footerData.contactInfo) {
      validated.contactInfo = {
        ...
        location: this.validateString(
          footerData.contactInfo.location,
          'Location'
        ),
        availability: this.validateString(
    ...
    if (footerData.styling) {
      validated.styling = {
        ...
        showBackgroundPattern: Boolean(
          footerData.styling.showBackgroundPattern
        ),
        patternOpacity: this.validateNumber(
          footerData.styling.patternOpacity,
          0,
          1,
          0.3
        ),
